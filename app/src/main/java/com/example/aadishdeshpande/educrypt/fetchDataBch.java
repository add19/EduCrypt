...
public class fetchDataBch extends AsyncTask<Void,Void,Void> {
    String data = "";
    String dataParsed = "";
    String singleParsed = "";
    static double x,y;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            URL url = new URL("https://min-api.cryptocompare.com/data/histoday?fsym=BCH&tsym=USD&limit=30&aggregate=1&e=CCCAGG");
